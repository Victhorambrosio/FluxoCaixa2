...
namespace FluxoCaixa.Controllers
{
    public class ContasController : Controller
    {
        ...
        {
            ViewData["TipoContaId"] = new SelectList(_context.TipoConta, "TipoContaId", "Nome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ContaId,Nome,Valor,DataVencimento,Pago,TipoContaId")] Conta conta)
        {
            ...
            ViewData["TipoContaId"] = new SelectList(_context.TipoConta, "TipoContaId", "Nome", conta.TipoContaId);
            return View(conta);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ContaId,Nome,Valor,DataVencimento,Pago,TipoContaId")] Conta conta)
        {
            if (id != conta.ContaId)
            {
                return NotFound();
